...
const GlobalStyles = () => (
  <style>{`
    @import url('https://fonts.googleapis.com/css2?family=Funnel+Display:wght@300;400;500;600;700&family=Inter:wght@300;400;500&display=swap&display=swap');
      ...
      <div className="overflow-hidden">
        ...
        >
          {galleryImages.map((img, idx) => (
            ...
            >
              <img src={img.src} alt={img.title} className="w-full h-full object-cover transition-transform duration-700 group-hover/item:scale-110" loading="lazy" /> {/* Otimização: Lazy Loading */}
...
const AccordionItem = ({ question, answer, isOpen, onClick }) => (
  <div className="border-b border-slate-200 last:border-0">
    <button className="flex justify-between items-center w-full py-6 text-left text-slate-800 hover:text-teal-700 transition group" onClick={onClick}>
    ...
    <div className="bg-white text-slate-800 font-sans min-h-screen antialiased selection:bg-teal-100 selection:text-teal-900">
        ...
        <div className="container mx-auto px-6 h-full flex justify-between items-center relative">
          ...
          <div className="lg:absolute lg:left-1/2 lg:-translate-x-1/2 lg:top-0 flex justify-center z-10">
             <div className="bg-white lg:px-6 lg:pb-3 lg:pt-3 lg:rounded-b-2xl shadow-lg border border-slate-200 lg:border-t-0 transition-all">
                <img src="https://cdn.agsup.com.br/grv/logo.png" alt="Grupo Restaura Vidas" className="h-12 w-auto lg:h-24 lg:w-auto object-contain transition-all duration-300" />
             </div>
          </div>
      ...
      <div className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 bg-slate-900 overflow-hidden min-h-[calc(100vh-6rem)] flex items-center">
        <div className="absolute inset-0 z-0">
          <img src="https://images.unsplash.com/photo-1594178056038-f86460166649?q=80&w=2070&auto=format&fit=crop" alt="Família feliz se abraçando" className="w-full h-full object-cover opacity-30" />
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2 text-center lg:text-left">
              <FadeIn>
                <div className="inline-flex items-center gap-2 py-1.5 px-4 rounded-full bg-white/5 border border-white/10 text-teal-300 text-sm font-medium mb-8 backdrop-blur-sm"><Clock size={14} /> Atendimento Humanizado 24 horas</div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                  ...
                  <Button variant="outline" onClick={() => handleWhatsApp()} className="min-w-[200px]"><WhatsAppIcon className="w-5 h-5" /> Falar no WhatsApp</Button>
                </div>
            ...
            <div className="lg:w-1/2 w-full hidden lg:block">
              <FadeIn delay={0.2}>
                <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-white/10 group bg-slate-800">
                  <img src="https://cdn.agsup.com.br/grv/imagem-clinica.jpeg?q=80&w=2070&auto=format&fit=crop" alt="Ambiente de Paz" className="w-full h-[450px] object-cover transition-transform duration-1000 group-hover:scale-105" />
      ...
      <Section bg="gray">
        <div className="container mx-auto">
           <div className="text-center mb-12 max-w-3xl mx-auto">
              ...
              <p className="text-slate-500 text-lg font-light leading-relaxed">Nossa equipe multidisciplinar desenvolveu protocolos específicos para cada tipo de dependência. Entendemos que cada substância age de forma diferente no organismo.</p>
           </div>
      ...
      <Section className="bg-white text-center max-w-5xl mx-auto">
        <FadeIn>
          ...
          <p className="text-xl text-slate-500 leading-relaxed mb-12 max-w-3xl mx-auto font-light">Sabemos que pedir ajuda não é fácil. Muitos tentam sozinhos, mas recaem. Aqui, você encontra <strong className="text-teal-700 font-semibold">acolhimento, cuidado e tratamento especializado</strong> — sem julgamentos.</p>
                ...
                <FadeIn key={i} delay={i * 0.1}>
                  <div className="bg-slate-900 rounded-2xl overflow-hidden shadow-2xl group h-full flex flex-col">
                     <div className="h-56 overflow-hidden relative">
                        <img src={unit.img} alt={unit.title} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" loading="lazy" />
                     ...
                     <div className="p-8 flex flex-col flex-grow">
                        ...
                        <div className="space-y-4 text-slate-300 text-sm mb-8 flex-grow">
                          <div className="flex gap-3"><MapPin className="text-teal-500 shrink-0" size={18} /><span>{unit.address}</span></div>
                          <div className="flex gap-3"><Phone className="text-teal-500 shrink-0" size={18} /><span>{unit.phone}</span></div>
                          <div className="flex gap-3"><Clock className="text-teal-500 shrink-0" size={18} /><span>24 horas - Todos os dias</span></div>
                        </div>

                        <div className="space-y-3">
                          <button onClick={handleCall} className="flex items-center justify-center gap-2 w-full text-white font-medium py-2 hover:text-teal-400 transition"><Phone size={16} /> Ligar Agora</button>
            ...
            <div className="lg:w-7/12 p-12 bg-white">
              ...
              <form className="space-y-5" onSubmit={handleSubmit}>
                ...
                <Button variant="whatsapp" className="w-full py-5 text-lg shadow-xl shadow-green-500/20 flex justify-center items-center gap-3 disabled:opacity-70" disabled={isSending}>
                   {isSending ? (<>Enviando...</>) : (<><WhatsAppIcon className="w-6 h-6" /> CHAMAR NO WHATSAPP</>)}
                </Button>
